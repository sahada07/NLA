...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='bet',
            name='bet_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='bets', to='betting_bettype'),
        ),
        migrations.AddField(
            model_name='bet',
            name='draw',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bet_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='odds', to='betting_bettype')),
